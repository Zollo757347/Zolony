  ...
  return (
    <article>
      ...
      <section>
        ...
        <Image src={require("../../../assets/notorand/not-gate.png")} alt="紅石電路中的 NOT Gate" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../../../assets/notorand/or-gate.png")} alt="紅石電路中的 OR Gate" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../../../assets/notorand/and-gate.png")} alt="紅石電路中的 AND Gate" width="50%"/>
      </section>
      ...
      <section>
        ...
        <Image src={require("../../../assets/notorand/xor-gate.png")} alt="紅石電路中的 XOR Gate" width="50%"/>
