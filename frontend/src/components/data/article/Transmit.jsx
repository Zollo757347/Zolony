  ...
  return (
    <article>
      ...
      <section>
        ...
        <Image src={require("../../../assets/transmit/connection.png")} alt="紅石粉傳遞紅石訊號" width="50%"/>
        ...
        <Image src={require("../../../assets/transmit/power-level.png")} alt="紅石粉傳遞紅石訊號" width="50%"/>
      </section>
      ...
      <section>
        ...
        <Image src={require("../../../assets/transmit/dust-adjust.png")} alt="滑鼠右鍵可以調整單格紅石粉的指向" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../../../assets/transmit/power.png")} alt="不同情形的亮與暗" width="50%"/>
        <p></p>
      </section>
