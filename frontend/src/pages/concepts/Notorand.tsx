...
import { Official_Map_4 } from "../../assets/json/levels";
  ...
  return (
    <article>
      ...
      <section>
        ...
        <Image src={require("../../assets/pictures/notorand/not-gate.png")} alt="紅石電路中的 NOT Gate" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../../assets/pictures/notorand/or-gate.png")} alt="紅石電路中的 OR Gate" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../../assets/pictures/notorand/and-gate.png")} alt="紅石電路中的 AND Gate" width="50%"/>
      </section>
