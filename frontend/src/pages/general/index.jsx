  ...
  return (
    <article>
      ...
      <section>
        ...
        <p><b>紅石</b>，或是你喜歡的話，可以叫它紅石系統。總之就是一個 Minecraft 中的系統，這個系統包含了很多與現實中的電路、機械相似的方塊與物品，讓你可以在遊戲中製造出各式各樣的機械結構。從小型的整人陷阱、中型的自動化農場，還是大型的機械結構（像是 <a href="https://www.youtube.com/watch?v=-BP7DhHTU-I">Minecraft 裡的 Minecraft</a>），都是單靠紅石就可以做出來的。</p>
      ...
      <section>
        ...
        <p><b>注意：Zolony 的帳號系統仍然在測試階段，因此我們並不能保證所有帳號資料都能永久保存，在正式版的帳號系統啟用以前，所有資料都有可能會遺失！</b></p>
      </section>
