...
import data from "../assets/json/levels/Official Map 2.json"
  ...
  return (
    <article>
      ...
      <section>
        ...
        <Image src={require("../assets/pictures/repeater/repeat.png")} alt="紅石中繼器接續訊號" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../assets/pictures/repeater/diode.png")} alt="紅石中繼器只能單向傳輸訊號" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../assets/pictures/repeater/delay.png")} alt="不同延遲的外觀" width="50%"/>
      ...
      <section>
        ...
        <Image src={require("../assets/pictures/repeater/lock.png")} alt="被鎖定的紅石中繼器" width="50%"/>
      </section>
