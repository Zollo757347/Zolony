...
const Adder = () => {
  return (
    ...
    <section>
      ...
      <Image src={require("../assets/pictures/adder/add-example-0.png")} alt="二進位加法" width="15%"/>

      <p>第一步，計算第一位數 1 + 1 = 2，因為和超過 2 了，所以就需要向第二位數進一。</p>
      <Image src={require("../assets/pictures/adder/add-example-1.png")} alt="二進位加法 第一位數" width="15%"/>

      <p>第二步，計算第二位數 1 + 0 = 1，再加上剛剛從第一位數來的進位，1 + 1 = 2，最後的和還是超過 2，所以要向第三位數進一。</p>
      <Image src={require("../assets/pictures/adder/add-example-2.png")} alt="二進位加法 第二位數" width="15%"/>
      
      <p>第三步，計算第三位數 1 + 1 = 2，再加上第二位數的進位，2 + 1 = 3，最後的和也超過 2 了，所以要向第四位數進一。</p>
      <Image src={require("../assets/pictures/adder/add-example-3.png")} alt="二進位加法 第三位數" width="15%"/>

      <p>最後一步，計算第四位數 0 + 0 = 0，再加上前面的進位，0 + 1 = 1，因為比 2 小，所以不需要再進位了。</p>
      <Image src={require("../assets/pictures/adder/add-example-4.png")} alt="二進位加法 第四位數" width="15%"/>
    ...
    <section>
      ...
      <Image src={require("../assets/pictures/adder/half-adder.png")} alt="各個角度的半加器" width="50%"/>
      <ul>
        <li>淺藍色：A</li>
        <li>粉紅色：B</li>
    ...
    <section>
      ...
      <Image src={require("../assets/pictures/adder/full-adder.png")} alt="各個角度的全加器" width="50%"/>
      <ul>
    ...
    <section>
      ...
      <Image src={require("../assets/pictures/adder/4-bits-adder.png")} alt="四位數全加器" width="50%"/>
    </section>
